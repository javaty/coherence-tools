 ...
 *
 * By default batch size iz zero, which causes all entries to be persisted in
 * a single call to the underlying data store.
 *
...
public abstract class AbstractBatchingCacheStore
     ...
     * Return batch size.
     *
     * @return number of items that will be persisted in a single batch
     ...
     *                   database call during a {@link #storeAll(Map)} invocation.
     */
