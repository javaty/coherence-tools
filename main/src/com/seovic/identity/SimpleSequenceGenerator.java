...
/**
 * Simplest possible implementation of {@link SequenceGenerator}
 * that stores sequence information locally, in memory.
 * <p/>
 * This {@link SequenceGenerator} implementation is not suitable
...
public class SimpleSequenceGenerator extends SequenceGenerator
    ...
    protected SequenceBlock allocateSequenceBlock()
        {
        return m_sequence.allocateBlock(getBlockSize());
        }
