...
/**
 * Abstract cache store implementation that uses Spring JDBC support for
...
public abstract class AbstractJdbcCacheStore<T>
    ...
    /**
     * Return SQL statement that should be executed in order to load
     * a single object.
     *
     * @return SQL statement that should be executed in order to load
     *         a single object
    ...
    /**
     * Return an object that can be used to map a single row from a
     * {@link ResultSet} into an object.
     *
     * @return helper object used to map a single row from a
     *         {@link ResultSet} into an object
     */
     ...
     *             store
     *
     * @return loaded object or null if the object for the specified key was
     *         not found
     */
    ...
    public void storeBatch(Map mapBatch)
        ...
        SqlParameterSource[] batch =
                SqlParameterSourceUtils.createBatch(mapBatch.values().toArray());
     ...
     * </pre>
     * and assuming that the key for <tt>LineItem</tt> objects is a custom
     * class <tt>LineItemId</tt> containing both the order id and the line item
     * id, this method should be implemented like this:
     * <pre>
     ...
     *
     * @param key  entry key that the primary key components should be
     *             obtained from
     *
