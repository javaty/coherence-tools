...
import com.seovic.util.Numbers;
 ...
 * <p/>
 * This processor has identical behavior to the built-in NumberIncrementor,
 * but it avoids unnecessary serialization within the cluster by updating
...
public class BinaryNumberIncrementor
     ...
     *                  of the increment
     * @param fPostInc  pass true to return the value as it was before
     ...
     */
    public BinaryNumberIncrementor(Number numInc, boolean fPostInc, int... indices)
        {
     ...
     *                  it was incremented, or pass false to return the
     *                  value as it is after it is incremented
     * @param navigator  PofNavigator to use to extract chile value.
     *                   If <tt>null</tt>, binary value of an entry will be
     *                   returned.
     */
    public BinaryNumberIncrementor(Number numInc, boolean fPostInc, PofNavigator navigator)
        {
        super(navigator);
        m_numInc   = numInc;
        m_fPostInc = fPostInc;
    ...
    public Object process(BinaryEntry entry)
        ...
        if (oldValue == null)
            {
            oldValue = Numbers.getDefaultValue(m_numInc.getClass());
            }

        Number newValue = Numbers.add(oldValue, m_numInc);
        set(pofValue, newValue);
        entry.updateBinaryValue(pofValue.applyChanges());

        return m_fPostInc ? newValue : oldValue;
        }
    ...
    public void readExternal(PofReader reader)
        ...
        m_numInc   = (Number) reader.readObject(10);
        m_fPostInc = reader.readBoolean(11);
        }
    ...
    public void writeExternal(PofWriter writer)
        ...
        writer.writeObject(10, m_numInc);
        writer.writeBoolean(11, m_fPostInc);
        }
    ...
    public boolean equals(Object o)
        ...
        return super.equals(o)
               && m_numInc.equals(processor.m_numInc)
               && m_fPostInc == processor.m_fPostInc;
        }
    ...
    public int hashCode()
        ...
        result = 31 * result + m_numInc.hashCode();
        result = 31 * result + (m_fPostInc ? 1 : 0);
        return result;
        }
