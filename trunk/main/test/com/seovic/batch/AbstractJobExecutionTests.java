...
import com.seovic.coherence.loader.XmlToCoherence;
 ...
 */
public abstract class AbstractJobExecutionTests
    {
    ...
    protected void printSteps(CompositeStep compositeStep, int indent)
        ...
        for (Step step : compositeStep.getSteps())
            {
            System.out.println(indentString(indent) + step.getName() + ": " + step.getResult().getStatus());
