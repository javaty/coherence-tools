...
public class JobSupport
    ...
    /**
     * Convenience constructor to immediately add name (which is mandatory but not
     * final).
     *
     * @param name  job name
     */
     ...
     * present. Care is needed with bean definition inheritance - if a parent bean
     * has a name, then its children need an explicit name as well, otherwise they
     * will not be unique.
     *
    ...
    /**
     * Set the name property. Always overrides the default value if this object is
     * a Spring bean.
     *
     * @param name  job name
     * 
