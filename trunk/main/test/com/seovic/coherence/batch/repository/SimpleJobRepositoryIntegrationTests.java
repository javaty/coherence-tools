...
@ContextConfiguration(locations = "/com/seovic/coherence/batch/repository/coherence-dao-test.xml")
public class SimpleJobRepositoryIntegrationTests
    ...
    public void testCreateAndFind()
        ...
        builder.addString("stringKey", "stringValue")
                .addLong("longKey", 1L)
    ...
    public void testSaveExecutionContext()
        ...
        StepExecution retrievedStepExec =
                jobRepository.getLastStepExecution(jobExec.getJobInstance(), step.getName());
